# Personal AI Employee — Codex Configuration
...
| `AI_Employee_Vault/Needs_Action/` | Tasks queued for Codex |
...
```bash
# Full Silver orchestrator (all watchers + scheduler + HITL + Codex polling)
...
# Manual Codex run
Codex --print --dangerously-skip-permissions "Process all items in AI_Employee_Vault/Needs_Action"
```
